...
export default function customDetailsSticker() {
    //Begin custom-details moving items here
    var hiddenElements = stickerWidgetHTML.hiddenElements;
    ...
    var uploadFile = document.querySelector('[data-product-attribute="input-file"] input[type="file"]');
    ...
    var stickerFinishRadios = Array.from(document.getElementById("stickerFinishSection").querySelectorAll(".form-radio"));
    ...
    var unionLabel = document.getElementById("unionLabelSection").getElementsByClassName("form-label--inlineSmall")[0];
    ...
    var orderMinimum = localStorage.getItem("orderMinimum");
