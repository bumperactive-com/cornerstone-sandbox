...
export default function handleImageUploadEvent(ai, tiff, svg, psd, eps, bmp) {
    document.querySelector(SELECTORS.FILE_INPUT).addEventListener('change', function(e) {
        ...
        if (this.files) {
            const imageLabel = document.querySelector(SELECTORS.IMAGE_FILE);
            ...
            //else if one of the display upload extensions
                ...
                document.querySelectorAll(SELECTORS.FILE_INPUT)[0].value = "";
