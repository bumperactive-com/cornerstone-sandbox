...
//Custom Size and Quantity selectors

export var customSectionElements = {
    customSizeForm: document.getElementById("customSizeForm"),
    customQuantityForm: document.getElementById("customQuantityForm"),
    firstBox: document.querySelector("#box1"),
    secondBox: document.querySelector("#box2"),
    thirdBox: document.querySelector("#box3"),
    label1: document.querySelector("#radioSize > form:nth-child(2) > label:nth-child(2)")
}
